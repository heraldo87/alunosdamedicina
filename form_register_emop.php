    ...
    <div class="relative w-full max-w-md mx-4">
        ...
        <div class="relative bg-white bg-opacity-80 backdrop-blur-md rounded-2xl shadow-2xl p-8 m-4">
            ...
            <div class="text-center mb-8">
                ...
                <p class="text-gray-600">Crie sua conta para ter acesso a área do colaborador</p>
            </div>
            ...
            <form id="registrationForm" onsubmit="return validateForm(event);" action="./php/cadastro_processar.php" method="POST">
                ...
                <!-- CPF -->
                <div class="mb-4">
                    <label for="ru" class="block text-sm font-medium text-gray-700 mb-1">CPF</label>
                    <input type="text" id="ru" name="ru"
                           class="w-full px-4 py-3 bg-gray-50 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 transition duration-300"
                           placeholder="Seu número de CPF" required>
                </div>

                <!-- Turma (Dropdown) -->
                <div class="mb-4">
                    <label for="turma" class="block text-sm font-medium text-gray-700 mb-1">Diretoria</label>
                    <select id="turma" name="turma" class="w-full px-4 py-3 bg-gray-50 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 transition duration-300" required>
                        <option value="" disabled selected>Selecione sua diretoria</option>
                        <option value="DIM">DIM - Manutenção</option>
                        <option value="DIM/ITAPERUNA">DIM/ITAPERUNA</option>
                        <option value="DIM/MACAÉ">DIM/MACAÉ</option>
                        <option value="DIM/NITERÓI">DIM/NITERÓI</option>
                        <option value="DIM/V. REDONDA">DIM/V. REDONDA</option>
                        <option value="DOB">DOB - Obras</option>
                        <option value="DPP">DPP - Planejamento e Projetos</option>
                        <option value="GER">GER - Gerenciamento</option>
                        <option value="PRE">PRE - Presidência</option>
