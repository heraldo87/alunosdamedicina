...
$webhook_url = 'http://localhost:5678/webhook-test/forum'; // Substitua com o seu URL de webhook
...
$data_to_send['Titulo'] = "Meu Primeiro Fórumoe";
$data_to_send['Descriação_breve'] = "Apens um pequeno teste para ver se as várivéis vão passar corretamente.";
$data_to_send['acao'] = 2;
