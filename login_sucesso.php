<?php
// Inclui o arquivo de verificação de autenticação para garantir que o usuário está logado
...
<body class="bg-gray-100 flex items-center justify-center min-h-screen">
    ...
    <div class="relative w-full max-w-md mx-4">
        ...
        <div class="relative bg-white bg-opacity-80 backdrop-blur-md rounded-2xl shadow-2xl p-8 m-4 text-center">
            ...
            <p class="text-gray-600 mb-6">Seu login foi realizado com sucesso. Você será redirecionado para o painel em breve.</p>
            
            <!-- Link para redirecionamento manual -->
            <p class="text-sm text-gray-500">Se não for redirecionado automaticamente, <a href="index.php" class="text-blue-600 hover:underline">clique aqui</a>.</p>
        </div>
    </div>
